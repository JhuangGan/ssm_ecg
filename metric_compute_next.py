...
def all_metric_compute(val_targs, val_preds, test_targs, test_preds):
    ...
    return val_macro_auc, val_macro_best_f1_score, val_macro_aupr, test_macro_auc, test_f1, test_macro_aupr
...
if __name__ == '__main__':
    ...
    test_macro_auc, test_f1, test_macro_aupr = all_metric_compute(val_targs, val_preds, test_targs, test_preds)
    

    print(val_macro_auc, val_f1_score, val_macro_aupr)
    print(test_macro_auc, test_f1, test_macro_aupr)
